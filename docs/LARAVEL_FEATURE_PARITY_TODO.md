...
- [~] Complete Eloquent model metadata: table, connection, keys, UUID/ULID, incrementing, timestamps, date formats, guarded/fillable, hidden/visible, appends, and serialization.
  ...
  - Source mapping: `Model.php` `toArray` (2033–2038), `getConnectionName`/`setConnection` (2236–2251), `getTable`/`setTable` (2301–2318), `qualifyColumn`/`getQualifiedKeyName` (736–749, 2347–2350); `HasTimestamps.php` `updateTimestamps` (87–104), `getCreatedAtColumn`/`getUpdatedAtColumn` (167–180); `HasAttributes.php` attribute serialization (225–458) and append controls (2447–2515); `HidesAttributes.php` hidden/visible controls (42–173).
